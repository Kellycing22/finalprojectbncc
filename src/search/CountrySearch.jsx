        ...
        <>
            <section className="flex flex-col items-center">
                <div className="flex flex-col gap-1">
                    <label htmlFor="countryName">Masukkan nama negara yang ingin dicari</label>
                    <input 
                ...
                <div>
                    <button 
                        onClick={ambilData} 
                        className="flex flex-col gap-10 self-start px-2 py-1 rounded-md mt-3 mb-3 bg-blue-400" 
                        type="button"
                    >
                        Submit
                    </button>
                ...
                <div className="flex gap-5 rounded-lg px-2 py-2 ml-5 mr-5 font-bold">
                    {data.length > 0 ? (
                        data.map((country, index) => (
                            <Link key={index} to={`/CountryDetail`}>
